...
const BlocklistUser = () => {
    const manager = new MapManager<AllPlatformBlocklistRecord, BlocklistItemValue>("BlockedUsers");
    const {
        platform,
        setPlatform,
        blocklist,
                ...
                <div className="flex flex-col gap-1.5">
                    <div className="flex gap-1.5">
                        ...
                        <InputText
                            ...
                            style="flex-grow"
                            placeholder={browser.i18n.getMessage("blockedUsers_input_placeholder")}
