...
const BlocklistEmote = () => {
    const manager = new MapManager<AllPlatformBlocklistRecord, BlocklistItemValue>("BlockedEmotes");
    const {
        platform,
        setPlatform,
        blocklist,
    ...
    return (
        <Main>
            <Navigation />
            <Dashboard title={browser.i18n.getMessage("navigation_blockedEmotes")}>
                <div className="flex flex-col gap-1.5">
                    <div className="flex gap-1.5">
                        ...
                        <InputText
                            ...
                            style="flex-grow"
                            placeholder={browser.i18n.getMessage("blockedEmotes_input_placeholder")}
