...
const SettingsCards: React.ComponentProps<typeof SettingsCard>[] = [
    {
        ...
        children: <PlatformCheckboxList<Danmaku> storageKey="Danmaku" itemKey="danmaku" />,
    },
    {
        title: `${browser.i18n.getMessage('danmaku_font')}`,
        description: `${browser.i18n.getMessage('danmaku_font_description')}`,
        children: (
            <InputText<Danmaku> dynamicPlaceholder={true} storageKey="Danmaku" itemKey="font" onEnter={(v) => InputTextFontOnEnter('font', v)} />
        ),
    },
    {
    ...
    },
    {
        ...
        children: <InputNumber<Danmaku> storageKey="Danmaku" itemKey="opacity" guide="%" max={100} />,
    },
    {
