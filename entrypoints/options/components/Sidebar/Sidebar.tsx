    ...
    return (
        <li>
            <NavLink
                to={props.to}
                className={({ isActive }) =>
                    isActive ? "bg-blue-700 text-white" : "bg-inherit text-black dark:text-white"
                }
            >
                <div className="text-xm flex items-center gap-x-1.5 rounded-md bg-inherit px-1.5 py-1">
                    <div
                        className={`rounded-md p-1 shadow-sm ${gradationList[props.gradationKey]}`}
                    >
                        ...
                        <li>
                            <ul>
                                ...
                                <ExternalLink
                                    ...
                                    target="_blank"
                                    imgSrc={github}
                                    linkSrc="https://github.com/styfishnoob/dr.maggot"
                                    gradationKey="black"
                                />
                            </ul>
                        </li>
